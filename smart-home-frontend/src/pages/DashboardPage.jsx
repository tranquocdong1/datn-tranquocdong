...
import {
  ...
  Users, Flame, Wind, Lightbulb, BedDouble,
  ShieldCheck, ShieldAlert, CheckCircle2, XCircle,
  AlertTriangle, CloudRain, Sun, Shirt,
} from 'lucide-react';
...
const DashboardPage = () => {
  ...
  useEffect(() => {
    ...
    getAccessStats(7).then((r) => setAccessData(r.data)).catch(console.error);
    getTempHistory(24).then((r) =>
      setTempHistory(
        r.data.map((d) => ({
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-2xl)' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <span style={{
          ...
          <span style={{
            ...
            background: hasAlert ? 'var(--danger-text)' : 'var(--success-text)',
          }} />
          {hasAlert
            ? (intruderAlert ? 'Phát hiện xâm nhập!' : 'Phát hiện khí gas!')
      ...
      {/* ── Charts ── */}
      <section>
        <SectionHeader title="Biểu đồ theo dõi" sub="Dữ liệu cảm biến và lịch sử truy cập" />
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div>
                ...
                <div style={{ fontSize: 11, color: 'var(--text-muted)', marginTop: 2 }}>24 giờ qua</div>
              </div>
              <div style={{ display: 'flex', gap: 14 }}>
                {[
                  ...
                  <span key={label} style={{
                    ...
                    <span style={{
                      width: 20, height: 2,
                      background: color, borderRadius: 2, display: 'inline-block',
                    }} />
                    {label}
                  </span>
                ))}
                ...
                <AreaChart data={tempHistory} margin={{ top: 4, right: 4, bottom: 0, left: -20 }}>
                  <defs>
                    <linearGradient id="tempGrad" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%"  stopColor="#EF9F27" stopOpacity={0.25} />
                      <stop offset="95%" stopColor="#EF9F27" stopOpacity={0}    />
                    </linearGradient>
                    <linearGradient id="humGrad" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%"  stopColor="#85B7EB" stopOpacity={0.25} />
                  ...
                  <Area
                    ...
                    fill="url(#tempGrad)"
                    dot={false}
                    activeDot={{ r: 4, fill: '#EF9F27', stroke: '#fff', strokeWidth: 2 }}
                  />
                  <Area
                    type="monotone"
                    dataKey="hum"
                    ...
                    fill="url(#humGrad)"
                    dot={false}
                    activeDot={{ r: 4, fill: '#85B7EB', stroke: '#fff', strokeWidth: 2 }}
                  />
                </AreaChart>
              </ResponsiveContainer>
            ) : (
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div>
                ...
                <div style={{ fontSize: 11, color: 'var(--text-muted)', marginTop: 2 }}>7 ngày qua</div>
              </div>
              <div style={{ display: 'flex', gap: 14 }}>
                {[
            ...
            {accessData.length > 0 ? (
              <ResponsiveContainer width="100%" height={200}>
                <BarChart data={accessData} margin={{ top: 4, right: 4, bottom: 0, left: -20 }}>
